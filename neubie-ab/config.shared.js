...
(function (root, factory) {
  ...
  var CONFIG = {
    ...
    scenarioIntros: {
      1: "로봇 상태에 '위험 상황'이 있을 수 있습니다. 3초간 로봇 정보를 파악하고 어떤 문제가 있었는지 알려주세요.",
      2: "보행 신호가 켜진 후 안전하게 통과할 수 있는 시간 안에 '횡단하기' 버튼을 눌러 이동해주세요.",
      3: "로봇 카메라를 응시하다 돌발 상황(로봇 쓰러짐, 충돌 등)이 발생할 위험이 보이면 '사이드브레이크'를 ON으로 변경해 로봇을 멈춰주세요.",
      5: '안내에 따라 로봇을 조작해주세요.',
      6: '카메라, 지도, 알림 등 정보로 로봇이 목적지에 도착했다고 판단되면, 시나리오에서 직접 [도착 처리]를 해주세요.'
    },
    ...
    scenarioAlerts: {
      ...
      6: [
        { delay: 12000, level: 5, msg: '뉴빌리티빌라 1동에 곧 도착합니다.' },
        { trigger: 'arrival', level: 5, msg: '뉴빌리티빌라 1동에 도착하였습니다' }
      ]
    },
